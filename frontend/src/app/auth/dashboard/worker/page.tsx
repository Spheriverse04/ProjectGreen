...
export default function WorkerDashboard() {
  ...
  const fetchUserProgress = async () => {
    setLoading(true);
    try {
      // fetch worker-specific progress
    ...
    <RoleGuard role="WORKER">
      <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-900 via-green-900 to-slate-900">
        ...
        <div className="relative z-10 p-6 space-y-8">
            ...
            <div className="game-card p-8">
              <div className="flex flex-col lg:flex-row items-center justify-between space-y-6 lg:space-y-0">
                <div className="text-center lg:text-left">
                  ...
                  <p className="text-gray-300 text-lg">
                    Track your training and improve your skills efficiently.
                  </p>
                </div>
              ...
              <div className="mt-6">
                ...
                <div className="xp-bar">
                  <div
                    className="xp-fill bg-green-500"
              ...
              {userRank && (
                <div className="mt-6">
                  ...
                  <div className="flex items-center justify-between p-4 bg-slate-800/50 rounded-xl border border-green-500/30">
                    <span className="text-green-300 font-bold text-lg">#{userRank.rank}</span>
                    <span className="text-white">{userRank.name} ({userRank.xp} XP)</span>
                  </div>
                </div>
              )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 slide-in-right">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-3xl font-bold text-white mb-2">🎮 Training Modules</h2>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-green-300">{moduleProgress.toFixed(0)}%</span>
                </div>
                <div className="w-full bg-slate-700 rounded-full h-3">
                  <div
                    className="bg-gradient-to-r from-teal-400 to-green-500 h-3 rounded-full transition-all duration-1000"
                    style={{ width: `${moduleProgress}%` }}
                  />
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-slate-800/50 rounded-xl border border-green-500/30">
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-slate-600 rounded-full flex items-center justify-center">1</div>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-800/50 rounded-xl border border-yellow-500/30">
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-slate-600 rounded-full flex items-center justify-center">3</div>
                    <span className="text-white">Watch 3 Videos</span>
                  </div>
                  <div className="text-yellow-400 font-bold">+30 XP</div>
                </div>

                <div className="flex items-center justify-between p-4 bg-slate-800/50 rounded-xl border border-teal-500/30">
                  <div className="flex items-center space-x-3">
                    <div className="w-8 h-8 bg-slate-600 rounded-full flex items-center justify-center">5</div>
                    <span className="text-white">Review 5 Flashcards</span>
                  </div>
                  <div className="text-teal-400 font-bold">+25 XP</div>
                </div>
              </div>
          ...
          <div className="slide-in-up">
            <div className="game-card p-8 text-center">
              <h2 className="text-3xl font-bold text-white mb-4">🌟 See Where You Stand</h2>
              <p className="text-gray-300 mb-6">
                Check the leaderboard to compare your progress with other workers!
              </p>
              <button
